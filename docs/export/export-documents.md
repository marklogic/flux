...
MarkLogic database you wish to write to:
    ...
    ./bin/flux export_files --path /path/to/files --connectionString "user:password@localhost:8000"
...
```
rm export/*.zip
./bin/flux export_files --connectionString nt-user:password@localhost:8004 \
