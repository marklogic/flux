...
To use Flux with `spark-submit`, first download the `flux-1.0.0.ea1-all.jar` file from the 
[GitHub release page](https://github.com/marklogic/flux/releases/tag/1.0.0.ea1). This jar file includes Flux and all of 
