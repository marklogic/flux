...
import com.marklogic.newtool.command.importdata.WriteUtil;
...
public class CopyCommand extends AbstractCommand<DocumentCopier> implements DocumentCopier {
    ...
    public static class CopyReadDocumentsParams extends ReadDocumentParams<DocumentCopier.CopyReadDocumentsOptions> implements DocumentCopier.CopyReadDocumentsOptions {
