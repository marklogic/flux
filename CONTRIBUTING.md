...
This will produce an assembly jar at `./flux-cli/build/libs/marklogic-flux-2.1.2-SNAPSHOT-all.jar`.
...
--master spark://NYWHYC3G0W:7077 flux-cli/build/libs/marklogic-flux-2.1.2-SNAPSHOT-all.jar \
...
flux-cli/build/libs/marklogic-flux-2.1.2-SNAPSHOT-all.jar \
