...
This will produce an assembly jar at `./new-tool-cli/build/libs/new-tool-cli-0.1.0-all.jar`.
...
--master spark://NYWHYC3G0W:7077 new-tool-cli/build/libs/new-tool-cli-0.1.0-all.jar \
