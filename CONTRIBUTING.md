...
This will produce an assembly jar at `./flux-cli/build/libs/marklogic-flux-*-all.jar`.
...
--master spark://NYWHYC3G0W:7077 flux-cli/build/libs/marklogic-flux-*-all.jar \
...
flux-cli/build/libs/marklogic-flux-*-all.jar \
